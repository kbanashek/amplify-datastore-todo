 ...
 */
export const parseAppointmentData = (data: AppointmentData): Appointment[] => {
  if (
 ...
 */
export const formatTime = (date: Date, timezoneId?: string): string => {
 ...
 */
export const getTimezoneAbbreviation = (timezoneId?: string | null): string => {
  if (!timezoneId) {
    return "";
  }
