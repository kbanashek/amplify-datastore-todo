...
export const GlobalHeader: React.FC<GlobalHeaderProps> = ({
  ...
  return (
    <View style={styles.header}>
      <View style={[styles.headerTop, rtlStyle(styles.headerTop)]}>
        <Text style={[styles.headerTitle, isRTL && { textAlign: "right" }]}>
          {translatedTitle}
        </Text>
        <View style={[styles.headerActions, rtlStyle(styles.headerActions)]}>
          {rightAction}
      ...
      <View style={[styles.headerBottom, rtlStyle(styles.headerBottom)]}>
