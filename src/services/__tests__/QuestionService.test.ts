...
describe('QuestionService', () => {
  ...
  describe('updateQuestion', () => {
    it('should update a question successfully', async () => {
      const originalQuestion = createMockQuestion({ id: 'test-id', text: 'Original' });
      const updatedQuestion = createMockQuestion({ id: 'test-id', text: 'Updated' });
      ...
      const result = await QuestionService.updateQuestion('test-id', { text: 'Updated' });
