...
import { TaskStatus, TaskType, CreateTaskInput, UpdateTaskInput } from '../../types/Task';
...
describe('TaskService', () => {
  ...
  describe('createTask', () => {
    ...
    it('should throw error on create failure', async () => {
      ...
      await expect(TaskService.createTask(input)).rejects.toThrow('Create failed');
    });
  });
  ...
  describe('getTasks', () => {
    ...
    it('should filter tasks by taskType', async () => {
      ...
      const result = await TaskService.getTasks({ taskType: [TaskType.SCHEDULED] });
