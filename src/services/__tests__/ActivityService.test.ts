...
describe('ActivityService', () => {
  ...
  describe('createActivity', () => {
    ...
    it('should throw error on create failure', async () => {
      ...
      await expect(ActivityService.createActivity(input)).rejects.toThrow('Create failed');
    });
  });
  ...
  describe('updateActivity', () => {
    it('should update an activity successfully', async () => {
      const originalActivity = createMockActivity({ id: 'test-id', name: 'Original' });
      const updatedActivity = createMockActivity({ id: 'test-id', name: 'Updated' });
      ...
      const result = await ActivityService.updateActivity('test-id', { name: 'Updated' });
  ...
  describe('deleteActivity', () => {
    ...
    it('should throw error if activity not found', async () => {
      ...
      await expect(ActivityService.deleteActivity('non-existent')).rejects.toThrow(
        'Activity with id non-existent not found'
      );
    });
  });
